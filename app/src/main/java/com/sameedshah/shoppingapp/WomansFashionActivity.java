...
import Adapters.MensFashionAdapter;
import Adapters.WomansFashionAdapter;

public class WomansFashionActivity extends AppCompatActivity {

    RecyclerView mRecycler;
    WomansFashionAdapter adapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_womans_fashion);
        ...
        mRecycler = findViewById(R.id.womanRecycler);
        mRecycler.setLayoutManager(new GridLayoutManager(this, 2));
        adapter = new WomansFashionAdapter(this,images,title,price);
    ...
    private void setToolbar(){
        ...
        getSupportActionBar().setTitle("Women's Fashion");
