...
public class ElectronicsAdapter extends RecyclerView.Adapter<ElectronicsAdapter.ViewHolder>{
    ...
    private ElectronicsAdapter.ItemClickListener mClickListener;

    public ElectronicsAdapter(Context context, int[] images, String[] titles, String[] price){
    ...
    @NonNull
    @Override
    public ElectronicsAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int i) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.latest_product_adapter,
                parent, false);
        return new ElectronicsAdapter.ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull ElectronicsAdapter.ViewHolder viewHolder, int i) {
    ...
    void setClickListener(ElectronicsAdapter.ItemClickListener itemClickListener) {
